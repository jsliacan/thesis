...
\newcommand{\PP}{\ensuremath{\textsf{P}}}
...
\newcommand{\W}{\ensuremath{\textsf{W}}}
%\newcommand{\QQ}{\ensuremath{\begingroup\fontencoding{LGR}\selectfont\char21\endgroup}} %Greek Koppa
...
\newcommand{\DDD}{\ensuremath{\textsf{D}}}
...
\newcommand{\flipud}[1]{\reflectbox{\rotatebox[origin=c]{180}{#1}}}
\newcommand{\fliplr}[1]{\reflectbox{#1}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DYCK PATHS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
